...
/* package JITCompiler-0.1.0.0 */
#define VERSION_JITCompiler "0.1.0.0"
#define MIN_VERSION_JITCompiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "JITCompiler-0.1.0.0-HQdkIkyia9UI6c5HIflwmv"

#define CURRENT_PACKAGE_KEY "JITCompiler-0.1.0.0-HQdkIkyia9UI6c5HIflwmv"
