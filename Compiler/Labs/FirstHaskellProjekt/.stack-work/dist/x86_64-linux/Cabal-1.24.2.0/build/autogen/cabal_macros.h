...
/* package FirstHaskellProjekt-0.1.0.0 */
#define VERSION_FirstHaskellProjekt "0.1.0.0"
#define MIN_VERSION_FirstHaskellProjekt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "FirstHaskellProjekt-0.1.0.0-6IJFBqvnY3DKBUEniOK3H8"

#define CURRENT_PACKAGE_KEY "FirstHaskellProjekt-0.1.0.0-6IJFBqvnY3DKBUEniOK3H8"
