...
/* package md2html-0.1.0.0 */
#define VERSION_md2html "0.1.0.0"
#define MIN_VERSION_md2html(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "md2html-0.1.0.0-262ulUAMmGV5hmWW08dDOC"

#define CURRENT_PACKAGE_KEY "md2html-0.1.0.0-262ulUAMmGV5hmWW08dDOC"
